    ...
    return new MaterialApp(
        ...
        home:Scaffold(
          appBar: AppBar(centerTitle: true,
                  actions: <Widget>[ 
                  IconButton(icon: Icon(Icons.exit_to_app), iconSize: 40.00, tooltip: 'Exit MnR',
                    onPressed: (){exit(0);},)],
                  title: Text('Maintenance And Repair',style: txtCss.txtRoboBoldHiLightColor(30.0, Colors.white), textAlign: TextAlign.center,)),
